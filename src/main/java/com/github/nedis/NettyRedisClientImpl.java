...
public class NettyRedisClientImpl implements RedisClient {
    ...
    public void get(String key, Callback callback) {
        Command cmd = new Command(CommandType.GET, new CommandArgs().addKey(key), callback);
        channel.write(cmd);
    }
    ...
    public static void main(String[] args) throws  Exception {
        final RedisClient redis = new NettyRedisClientImpl("192.168.1.243");
        redis.subscribe("mq1");
        ...
        final RedisClient rr = new NettyRedisClientImpl("192.168.1.243");
        rr.publish("mq1", "你是谁啊");
